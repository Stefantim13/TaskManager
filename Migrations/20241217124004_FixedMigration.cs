        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    WorkspaceID = table.Column<int>(type: "int", nullable: true),
                    WorkspaceRoleID = table.Column<int>(type: "int", nullable: true)
                },
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Workings_AspNetUsers_UserId1",
                        column: x => x.UserId1,
                        principalTable: "AspNetUsers",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Workings_WorkspaceRoles_WorkspaceRoleID",
                        column: x => x.WorkspaceRoleID,
                        principalTable: "WorkspaceRoles",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Workings_Workspaces_WorkspaceID",
                        column: x => x.WorkspaceID,
                        principalTable: "Workspaces",
                        principalColumn: "ID");
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Workings_UserId1",
                table: "Workings",
                column: "UserId1");

            migrationBuilder.CreateIndex(
                name: "IX_Workings_WorkspaceID",
                table: "Workings",
                column: "WorkspaceID");
